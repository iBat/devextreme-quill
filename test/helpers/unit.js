...
function compareHTML(actual, expected, ignoreClassId, ignoreUI = true) {
  ...
  let ignoredAttributes = [
    ...
    'data-tableborderwidth',
    'data-tablewidth',
    'data-tableheight',
    'data-tablebackgroundcolor',
    'data-cellwidth',
    'data-cellheight',
    'data-cellborder',
    'data-cellbordercolor',
    'data-cellborderstyle',
    'data-cellborderwidth',
    'data-cellpadding',
    'data-cellpaddingtop',
    'data-cellpaddingbottom',
    'data-cellpaddingleft',
    'data-cellpaddingright',
    'data-cellbackgroundcolor',
    'data-celltextalign',
    'data-cellverticalalign',
    'contenteditable',
  ];
  if (ignoreClassId) {
